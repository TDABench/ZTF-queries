...
#
# Description:
#     Utility functions for working with Zwicky Transient Facility (ZTF) alert data,
#     including functions to handle alert packet parsing, image triplets, database
#     querying, and alert plotting.
#
# Original Author: Nabeel Rehemtulla
# Copyright (c) 2020-2024 Nabeel Rehemtulla
# License: MIT License
#
# For usage instructions, updates, and full documentation, visit the GitHub repository:
...
def prep_alerts(alerts, label):
    """
    Reorganizes dict structure, adds values for custom features, and adds labels
    ...
    -------
    alert_df: DataFrame
        alerts represented as DataFrame with custom features,
        and labels added in
    """
